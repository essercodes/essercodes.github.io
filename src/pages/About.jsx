...
function About() {
    return <Page compactTitle="About" path="about">
        ...
        <div>
            ...
            <p>
                Praesent elit libero, imperdiet ut consequat eu, rutrum pellentesque sem. Curabitur massa diam, elementum
                ...
                bibendum. In ex enim, maximus non ipsum quis, vehicula fringilla risus. Fusce ut maximus erat.
            </p>
            <p>
                Sed vel pulvinar ante. Nunc lobortis elit ante, ut gravida neque rutrum quis. Morbi vitae condimentum
                ...
                sed condimentum magna.
            </p>
            <p>
                Praesent finibus lacinia malesuada. Duis suscipit justo ante, et sollicitudin magna ullamcorper ac.
                ...
                fringilla ac turpis. Sed lobortis nec dolor quis dictum.
            </p>
        </div>
    </Page>
}
